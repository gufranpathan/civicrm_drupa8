...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:LsQvny2fJBdtzaVd@mariadb/drupal?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://dev.civicrm.gufran-pathan.wod.by//sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupal:LsQvny2fJBdtzaVd@mariadb/drupal?new_link=true');
  }
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/mnt/files/private/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://dev.civicrm.gufran-pathan.wod.by');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'fq2KboyfsguaSGOXpsvtOqnjhMceW7szjUkvNlNLJo');
}
...
// define( 'CIVICRM_MAIL_LOG', '/mnt/files/private/civicrm/templates_c/mail.log');
// }
